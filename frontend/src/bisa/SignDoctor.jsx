...
const SignDoctor = () => {
  ...
  return (
    <div className="flex flex-col items-center mx-auto p-5  text-[#3D3743]">
      <h1 className="text-center font-bold text-[24px] font-Archivo">
      ...
      <div className="p-5 w-[507px] bg-[#F3FBFA] mt-10">
        {isLogin ? (
          <>
            ...
            <p className="mt-2 text-[#2F5760]">
              ...
              <span
                ...
                onClick={() => setIsLogin(false)}
              >
                <a href="/auth/signDoctor">Register here</a>
              </span>
            </p>
          </>
        ) : (
          <>
            ...
            <form onSubmit={handleRegister}>
              ...
              <div className="flex flex-col my-2">
                <h6 className="mb-4">Professional Information</h6>
                ...
                <input
                  type="text"
                  className="w-full border-[#2F5760] p-3 border mt-1 mb-3 text-[#2D2C45] "
                  placeholder="Select your specilization"
                  value={specilization}
            ...
            <p className="mt-5  text-[#2E3F4E] text-center">
              ...
              <span
                className="hover:text-blue-500 mx-1 cursor-pointer"
                onClick={() => setIsLogin(true)}
              >
                Sign in
              </span>
